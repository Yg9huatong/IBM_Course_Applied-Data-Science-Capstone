...
def get_pie_chart(site):
    ...
    if site=='ALL':
        ...
        fig = px.pie(df1, values='class count', names='class', title='Total Success Launches for site')
        return fig
...
def scatter(site,payload):
    ...
    if site=='ALL':
        ...
        fig=px.scatter(mask_filtered,x='Payload Mass (kg)',y='class',color='Booster Version Category',title='Success count on Payload Mass for')
        return fig
